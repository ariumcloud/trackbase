...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      ...
      { url: "/trackbase-icon-192-v3.png", sizes: "192x192", type: "image/png" },
      { url: "/trackbase-icon-512-v3.png", sizes: "512x512", type: "image/png" },
    ],
    apple: [{ url: "/trackbase-apple-touch-icon-v3.png", sizes: "180x180", type: "image/png" }],
  },
};
  ...
  return (
    <html lang="pt-BR">
      <head>
        ...
        <link rel="apple-touch-icon" href="/trackbase-apple-touch-icon-v3.png" sizes="180x180" />
