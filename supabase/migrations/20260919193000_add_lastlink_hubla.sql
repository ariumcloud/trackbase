-- Allow Lastlink and Hubla as valid payment providers in integrations and sales
...
alter table public.utm_integrations add constraint utm_integrations_provider_check
  check (provider in ('meta','hotmart','kiwify','cakto','kirvano','eduzz','monetizze','wiapy','lowfy','greenn','stripe','google','yampi','perfectpay','cartpanda','shopify','ticto','lastlink','hubla'));
...
begin
  select * into strict i
   ...
   where id=p_integration and provider in ('hotmart','kiwify','cakto','kirvano','eduzz','monetizze','wiapy','lowfy','greenn','stripe','yampi','perfectpay','cartpanda','shopify','ticto','lastlink','hubla')
   for update;
