-- Outbox durável para eventos CAPI. O payload técnico permanece cifrado.
...
-- Enfileira no mesmo commit do evento de tracking. Sem event_id não há CAPI,
-- pois não seria possível garantir a deduplicação com o Pixel do navegador.
